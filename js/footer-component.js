            ...
            <div class="col-md-6 d-flex flex-column align-items-center align-items-md-end justify-content-start mb-3">
              ...
              <div>
                <ul class="d-flex flex-md-column flex-row list-unstyled">
                  ...
                  <li><a href="mapa_interactivo.html" class="text-white text-decoration-none">Mapa interactivo</a></li>
                  <li><a href="proponer_datos.html" class="text-white text-decoration-none">Proponer datos</a></li>
